        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
            ...
            // Calculate tax for married filing jointly/qualified widow(er)
                ...
                if (income <= 19050){
                 ...
                 tax = 19050 * 0.10 + (77400 - 19050) * 0.12 +
                       (165000 - 377400) * 0.22 + (income - 165000) * 0.24;
                 taxRate = 24;
...
function clearButton () {
            ...
            //This code resets the dropdown box to the "Married filing jointly/widow(er)" filer status
